...
public class CredentialRoute {
  ...
  public static void attachRoutes(Router router) {
    ...
    router.get(CredentialRoute.suffix + "/:id").handler(CredentialController::isMe);
    router.get(CredentialRoute.suffix + "/:id").handler(CredentialController::verifyProperties);
